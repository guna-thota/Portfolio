...
const projects = [
  {
    ...
    oneLiner: "NL-to-SQL workflow with LangGraph orchestration and RAG architecture for multi-step analytical reasoning.",
    ...
    architectureSvg: (
      <svg viewBox="0 0 920 260" width="100%" height="220">
        ...
        <rect x="35" y="95" width="160" height="70" rx="14" fill="rgba(15,36,58,0.55)" stroke="rgba(78,168,222,0.35)" />
        <text x="115" y="127" fill="white" fontSize="13" textAnchor="middle">User Question</text>
        <text x="115" y="148" fill="rgba(255,255,255,0.6)" fontSize="11" textAnchor="middle">natural language</text>

        <rect x="235" y="95" width="180" height="70" rx="14" fill="rgba(15,36,58,0.55)" stroke="rgba(78,168,222,0.35)" />
        <text x="325" y="127" fill="white" fontSize="13" textAnchor="middle">LangGraph Agent</text>
        <text x="325" y="148" fill="rgba(255,255,255,0.6)" fontSize="11" textAnchor="middle">RAG + orchestration</text>

        <rect x="465" y="95" width="180" height="70" rx="14" fill="rgba(15,36,58,0.55)" stroke="rgba(78,168,222,0.35)" />
        <text x="555" y="127" fill="white" fontSize="13" textAnchor="middle">SQL Translation</text>
        <text x="555" y="148" fill="rgba(255,255,255,0.6)" fontSize="11" textAnchor="middle">schema-aware · GPT-4o</text>

        <rect x="695" y="95" width="180" height="70" rx="14" fill="rgba(15,36,58,0.55)" stroke="rgba(78,168,222,0.35)" />
        <text x="785" y="127" fill="white" fontSize="13" textAnchor="middle">DuckDB Engine</text>
        <text x="785" y="148" fill="rgba(255,255,255,0.6)" fontSize="11" textAnchor="middle">execute · return results</text>

        <line x1="195" y1="130" x2="235" y2="130" stroke="url(#azg3)" strokeWidth="2" markerEnd="url(#arr)" />
        <line x1="415" y1="130" x2="465" y2="130" stroke="url(#azg3)" strokeWidth="2" />
        <line x1="645" y1="130" x2="695" y2="130" stroke="url(#azg3)" strokeWidth="2" />
      </svg>
    ),
  },
  {
    ...
    architectureTitle: "Architecture – ELT Integration Flow",
    architectureSvg: (
      <svg viewBox="0 0 920 260" width="100%" height="220">
        <defs>
        ...
        <rect x="35" y="95" width="160" height="70" rx="14" fill="rgba(15,36,58,0.55)" stroke="rgba(78,168,222,0.35)" />
        <text x="115" y="127" fill="white" fontSize="13" textAnchor="middle">Source Systems</text>
        <text x="115" y="148" fill="rgba(255,255,255,0.6)" fontSize="11" textAnchor="middle">APIs · DBs · Files</text>

        <rect x="235" y="95" width="180" height="70" rx="14" fill="rgba(15,36,58,0.55)" stroke="rgba(78,168,222,0.35)" />
        <text x="325" y="127" fill="white" fontSize="13" textAnchor="middle">ADF Pipelines</text>
        <text x="325" y="148" fill="rgba(255,255,255,0.6)" fontSize="11" textAnchor="middle">ingest · schedule · retry</text>

        <rect x="465" y="95" width="180" height="70" rx="14" fill="rgba(15,36,58,0.55)" stroke="rgba(78,168,222,0.35)" />
        <text x="555" y="127" fill="white" fontSize="13" textAnchor="middle">Databricks/PySpark</text>
        <text x="555" y="148" fill="rgba(255,255,255,0.6)" fontSize="11" textAnchor="middle">transform · validate</text>

        <rect x="695" y="95" width="180" height="70" rx="14" fill="rgba(15,36,58,0.55)" stroke="rgba(78,168,222,0.35)" />
        <text x="785" y="127" fill="white" fontSize="13" textAnchor="middle">Delta Lake / ADLS</text>
        <text x="785" y="148" fill="rgba(255,255,255,0.6)" fontSize="11" textAnchor="middle">bronze → silver → gold</text>

        <line x1="195" y1="130" x2="235" y2="130" stroke="url(#azg1)" strokeWidth="2" />
        <line x1="415" y1="130" x2="465" y2="130" stroke="url(#azg1)" strokeWidth="2" />
        <line x1="645" y1="130" x2="695" y2="130" stroke="url(#azg1)" strokeWidth="2" />
      </svg>
    ),
  },
];
      ...
      {open ? (
        ...
        >
          <motion.div
            ...
            style={{ width: "min(920px, 96vw)", borderRadius: 18, border: "1px solid rgba(255,255,255,0.12)", background: "linear-gradient(180deg, rgba(15,25,40,0.92), rgba(10,18,30,0.92))", boxShadow: "0 24px 80px rgba(0,0,0,0.55)", overflow: "hidden" }}
          >
    ...
    <div>
      ...
      <div className="shell">
        ...
        <div className="topbar">
          <div className="brand">
            <svg className="logo" viewBox="0 0 44 44" fill="none">
              <rect width="44" height="44" rx="16" fill="url(#lg)" />
              <defs>
              ...
              <text x="22" y="28" textAnchor="middle" fill="white" fontSize="18" fontWeight="800">G</text>
            </svg>
            <div>
          ...
          <div className="actions" style={{ flexWrap: "wrap" }}>
            ...
            <a className="btn" href="mailto:gunaprashant@gmail.com" style={{ display: "inline-flex", alignItems: "center" }}>
              <Mail className="h-4 w-4" />
              <span style={{ marginLeft: 8 }}>Email</span>
            </a>

            <a className="btn" href="https://www.linkedin.com/in/gthota27/" target="_blank" rel="noreferrer" style={{ display: "inline-flex", alignItems: "center" }}>
              <Linkedin className="h-4 w-4" />
              <span style={{ marginLeft: 8 }}>LinkedIn</span>
            </a>

            <a className="btn" href="https://github.com/guna-thota" target="_blank" rel="noreferrer" style={{ display: "inline-flex", alignItems: "center" }}>
              <Github className="h-4 w-4" />
              <span style={{ marginLeft: 8 }}>GitHub</span>
            </a>

            <a className="btn" href="https://leetcode.com/u/prashanth_thota/" target="_blank" rel="noreferrer" style={{ display: "inline-flex", alignItems: "center" }}>
              <Code2 className="h-4 w-4" />
              <span style={{ marginLeft: 8 }}>LeetCode</span>
            </a>

            <a
              className="btn"
              href="/Guna_Resume.pdf"
              download
              style={{ display: "inline-flex", alignItems: "center", background: "rgba(34,197,94,0.12)", borderColor: "rgba(34,197,94,0.30)" }}
            >
          ...
          <motion.div className="card" whileHover={{ y: -2 }}>
            <div className="cardInner">
              ...
              <div className="subtitle">
                {headline}. I build Azure data systems that stay stable under real-world conditions — bad data, late arrivals, retries, and changing schemas. At Hexaware, I cut pipeline runtime by <b>30%</b> and reduced batch failures by <b>20%</b> on TB-scale healthcare data processing <b>10M+ records daily</b>.
              </div>
              ...
              <div className="panel" style={{ marginTop: 12 }}>
                ...
                <div style={{ marginTop: 8, color: "rgba(255,255,255,0.82)", lineHeight: 1.55 }}>
                  ...
                  <div>Expanding into LLM pipelines, Apache Airflow orchestration, and real-time streaming.</div>
                </div>
              </div>
          ...
          <motion.div className="card" whileHover={{ y: -2 }}>
            <div className="cardInner">
              <div className="sectionTitle" style={{ marginTop: 0 }}>
                <h2>Projects</h2>
                <p>Selected work + architecture</p>
              </div>
                ...
                <div style={{ display: "grid", gap: 10, marginTop: 10 }}>
                  {projects.map((p) => (
                    <motion.div
                      key={p.id}
                      className="panel"
                      style={{ padding: 12, border: "1px solid rgba(255,255,255,0.08)", background: "linear-gradient(180deg, rgba(255,255,255,0.05), rgba(255,255,255,0.03))" }}
                      whileHover={{ y: -2 }}
                    >
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10 }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 10, minWidth: 0 }}>
                          ...
                          <div style={{ minWidth: 0 }}>
                            ...
                            <div style={{ fontSize: 12, color: "rgba(255,255,255,0.6)", marginTop: 2 }}>{p.oneLiner}</div>
                          </div>
                        </div>
                        <div style={{ display: "flex", gap: 8, flexShrink: 0 }}>
                          <a className="btn" href={p.url} target="_blank" rel="noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
                            <ExternalLink className="h-3 w-3" /> Repo
                          </a>
                          <button className="btn" onClick={() => setActiveProject(p)}>Architecture</button>
                        </div>
                      </div>
                      ...
                      <div style={{ marginTop: 8, display: "flex", flexWrap: "wrap", gap: 6 }}>
                        {p.stack.map((s) => (
                          <span key={s} style={{ fontSize: 11, padding: "3px 8px", borderRadius: 999, border: "1px solid rgba(34,197,94,0.25)", background: "rgba(34,197,94,0.07)", color: "rgba(255,255,255,0.72)" }}>{s}</span>
                        ))}
                      </div>
                      ...
                      <div style={{ marginTop: 10 }}>
                        ...
                        <ul className="list" style={{ marginTop: 8 }}>
                          {p.metrics.map((m) => (
                            <li key={m}><span className="dot" /><span>{m}</span></li>
                          ))}
                        </ul>
                      </div>
                    </motion.div>
              ...
              <div className="panel">
                ...
                <ul className="list" style={{ marginTop: 10 }}>
                  <li><span className="dot" /><span>I build pipelines with <b>clear contracts</b> (schema + SLAs) and enforce validation early.</span></li>
                  <li><span className="dot" /><span>I design for <b>recovery</b>: retries, idempotency, and backfills without duplicate data.</span></li>
                  <li><span className="dot" /><span>I tune for <b>cost and speed</b>: incremental loads, partitions, and query performance.</span></li>
                </ul>
              </div>
            </div>
          </motion.div>
        ...
        <div className="sectionTitle" style={{ marginTop: 28 }}>
          <h2 style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <Briefcase className="h-5 w-5" style={{ opacity: 0.7 }} /> Work Experience
          </h2>
        </div>

        <motion.div className="card" whileHover={{ y: -2 }} style={{ marginTop: 8 }}>
          <div className="cardInner">
            <div style={{ display: "grid", gap: 16 }}>
              {experience.map((exp, i) => (
                <div key={i} style={{ paddingBottom: i < experience.length - 1 ? 16 : 0, borderBottom: i < experience.length - 1 ? "1px solid rgba(255,255,255,0.07)" : "none" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12, flexWrap: "wrap" }}>
                    <div>
                      <div style={{ fontWeight: 800, fontSize: 15 }}>
                        {exp.role} {exp.suffix && <span style={{ fontWeight: 400, color: "rgba(255,255,255,0.55)", fontSize: 13 }}>{exp.suffix}</span>}
                      </div>
                      <div style={{ fontSize: 13, color: "rgba(255,255,255,0.65)", marginTop: 2 }}>{exp.company} — {exp.location}</div>
                    </div>
                    <span style={{ fontSize: 12, padding: "4px 10px", borderRadius: 999, border: "1px solid rgba(255,255,255,0.12)", background: "rgba(255,255,255,0.05)", color: "rgba(255,255,255,0.6)", whiteSpace: "nowrap" }}>
                      {exp.period}
                    </span>
                  </div>
                  <ul className="list" style={{ marginTop: 10 }}>
        ...
        <div className="pipelineWrap">
          ...
          <motion.div className={cx("card", "pipelineCard")} whileHover={{ y: -2 }}>
            <svg width="100%" height="130" viewBox="0 0 1120 130" style={{ position: "absolute", left: 0, top: 0, opacity: 0.55, pointerEvents: "none" }} preserveAspectRatio="none">
              <defs>
              ...
              {[0, 1, 2].map((i) => (
                <circle key={i} r={3} cx={40} cy={70} fill="rgba(255,255,255,0.55)" filter="url(#glow)" opacity={0.38}>
              ...
              <div className="panel">
                <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", gap: 12 }}>
                  <div>
                    ...
                    <div style={{ marginTop: 6, fontSize: 12, color: "rgba(255,255,255,0.55)" }}>{summaryMode ? "Summary" : "Details"}</div>
                  </div>
                ...
                <AnimatePresence mode="wait">
                  {summaryMode ? (
                    <motion.ul key="summary" className="list" initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -6 }} transition={{ duration: 0.16 }} style={{ marginTop: 12 }}>
                      {summary.bullets.map((b) => (
                        <li key={b}><span className="dot" /><span>{b}</span></li>
                      ))}
                    </motion.ul>
                  ) : (
                    <motion.div key="technical" initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -6 }} transition={{ duration: 0.16 }} style={{ marginTop: 12 }}>
                      <div className="smallTitle">Tech</div>
                      <div className="stack">
                        {tech.tech.map((t) => <span key={t} className="stackChip">{t}</span>)}
                      </div>
                      <div style={{ height: 12 }} />
                      <div className="smallTitle">Reliability controls</div>
                      <ul className="list" style={{ marginTop: 10 }}>
                        {tech.reliability.map((r) => (
                          <li key={r}><span className="dot" /><span>{r}</span></li>
                        ))}
                      </ul>
                    </motion.div>
                  )}
        ...
        <div className="sectionTitle" style={{ marginTop: 28 }}>
          <h2 style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <Award className="h-5 w-5" style={{ opacity: 0.7 }} /> Certifications
          </h2>
        </div>
              ...
              {certifications.map((cert) => (
                <div key={cert.code} className="panel" style={{ padding: 14 }}>
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
                    <span style={{ fontSize: 11, padding: "3px 8px", borderRadius: 999, border: "1px solid rgba(139,92,246,0.35)", background: "rgba(139,92,246,0.10)", color: "rgba(255,255,255,0.8)", fontWeight: 700 }}>
                      {cert.code}
                    </span>
                    <span style={{ fontSize: 11, color: "rgba(255,255,255,0.45)" }}>{cert.date}</span>
                  </div>
                  <div style={{ fontWeight: 700, fontSize: 13, lineHeight: 1.35 }}>{cert.name}</div>
                  <div style={{ fontSize: 12, color: "rgba(255,255,255,0.5)", marginTop: 4 }}>{cert.issuer}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="sectionTitle" style={{ marginTop: 28 }}>
          <h2 style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <GraduationCap className="h-5 w-5" style={{ opacity: 0.7 }} /> Education
          </h2>
        </div>
        ...
        <motion.div className="card" whileHover={{ y: -2 }} style={{ marginTop: 8 }}>
          <div className="cardInner">
            <div style={{ display: "grid", gap: 14 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12, flexWrap: "wrap" }}>
                <div>
                  <div style={{ fontWeight: 800, fontSize: 15 }}>M.S. Computer Science</div>
                  <div style={{ fontSize: 13, color: "rgba(255,255,255,0.65)", marginTop: 2 }}>Purdue University Northwest — Indiana, USA</div>
                </div>
                <span style={{ fontSize: 12, padding: "4px 10px", borderRadius: 999, border: "1px solid rgba(255,255,255,0.12)", background: "rgba(255,255,255,0.05)", color: "rgba(255,255,255,0.6)", whiteSpace: "nowrap" }}>
                  Aug 2023 – May 2025
                </span>
              </div>
              <div style={{ borderTop: "1px solid rgba(255,255,255,0.07)", paddingTop: 14, display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12, flexWrap: "wrap" }}>
                <div>
                  <div style={{ fontWeight: 800, fontSize: 15 }}>B.Tech Electronics & Communication Engineering</div>
                  <div style={{ fontSize: 13, color: "rgba(255,255,255,0.65)", marginTop: 2 }}>Sreenidhi Institute of Science & Technology (SNIST) — Hyderabad, India</div>
                </div>
                <span style={{ fontSize: 12, padding: "4px 10px", borderRadius: 999, border: "1px solid rgba(255,255,255,0.12)", background: "rgba(255,255,255,0.05)", color: "rgba(255,255,255,0.6)", whiteSpace: "nowrap" }}>
                  Aug 2018 – Jun 2022
                </span>
        ...
        <motion.div className="card" whileHover={{ y: -2 }} style={{ marginTop: 8 }}>
          <div className="cardInner">
            <div className="stack">
              ...
              <a className="stackChip" href="mailto:gunaprashanth.tech@gmail.com">gunaprashanth.tech@gmail.com</a>
              <a className="stackChip" href="https://www.linkedin.com/in/gthota27/" target="_blank" rel="noreferrer">linkedin.com/in/gthota27</a>
              <a className="stackChip" href="https://github.com/guna-thota" target="_blank" rel="noreferrer">github.com/guna-thota</a>
              <a className="stackChip" href="https://leetcode.com/u/prashanth_thota/" target="_blank" rel="noreferrer">LeetCode</a>
            </div>
          </div>
        </motion.div>
      ...
      <Modal open={!!activeProject} title={activeProject?.architectureTitle || "Architecture"} onClose={() => setActiveProject(null)}>
        {activeProject ? (
          <div>
            ...
            <div style={{ borderRadius: 16, border: "1px solid rgba(255,255,255,0.10)", background: "linear-gradient(180deg, rgba(255,255,255,0.04), rgba(255,255,255,0.02))", padding: 12 }}>
